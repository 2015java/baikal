 ...
 * @author kowalski
 * Baikal中执行的游荡字段的结构
 * 在HashMap的基础上使用String化的key对Baikal做拓展
 */
public final class BaikalRoam extends HashMap<String, Object> {

  private static final long serialVersionUID = 2241673818101234922L;

  public BaikalRoam(int initialCapacity, float loadFactor) {
    super(initialCapacity, loadFactor);
  }

  public BaikalRoam(int initialCapacity) {
  ...
  public BaikalRoam(Map<String, Object> map) {
    super(map);
  }
