 ...
 * @author kowalski
 */
public final class BaikalLongCodec implements ObjectSerializer, ObjectDeserializer {

  private static final BaikalLongCodec INSTANCE = new BaikalLongCodec();

  public static BaikalLongCodec getInstance() {
    return INSTANCE;
  }
