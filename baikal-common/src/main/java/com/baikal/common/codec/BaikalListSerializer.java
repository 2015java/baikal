package com.baikal.common.codec;
...
import com.baikal.common.enums.BaikalSerializerFeature;
 ...
 * @author kowalski
 */
public final class BaikalListSerializer implements ObjectSerializer {

  private static final BaikalListSerializer INSTANCE = new BaikalListSerializer();

  public static BaikalListSerializer getInstance() {
    return INSTANCE;
  }
  ...
  public void write(JSONSerializer serializer, Object object, Object fieldName, Type fieldType, int features)
      throws IOException {
    boolean isCustomNumber = serializer.out.isEnabled(BaikalSerializerFeature.CUSTOM_NUMBER_SHOW.getMask()) || (
        (features & BaikalSerializerFeature.CUSTOM_NUMBER_SHOW.getMask()) != 0);
